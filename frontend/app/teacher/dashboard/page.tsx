...
export default function TeacherDashboard() {
    ...
    useEffect(() => {
        if (status === "unauthenticated") {
            ...
            fetch(`${process.env.NEXT_PUBLIC_BACKEND_URL || "http://localhost:5000"}/teacher/dashboard`, {
                credentials: "include"
            })
                .then(res => res.json())
    ...
    return (
        <div className="min-h-screen bg-background p-8">
            <div className="max-w-7xl mx-auto">
                ...
                <Card>
                    <CardHeader>
                        <CardTitle>Welcome, {session?.user?.firstName || "Teacher"}!</CardTitle>
                    </CardHeader>
                    <CardContent>
                        <div className="space-y-4">
                            ...
                            <div>
                                ...
                                <p className="font-medium">{session?.role || "Teacher"}</p>
                            </div>
                            {dashboardData && (
